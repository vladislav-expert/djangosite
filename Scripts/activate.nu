...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Vlad\Программирование\Python\SitePortfolio'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Vlad\Программирование\Python\SitePortfolio\Scripts\deactivate.nu'
